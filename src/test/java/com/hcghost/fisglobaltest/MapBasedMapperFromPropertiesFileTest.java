 ...
 * @author hcg
 */
public class MapBasedMapperFromPropertiesFileTest {
    
    public MapBasedMapperFromPropertiesFileTest() {
    }
    ...
    public void testMap() {
        ...
        String s = "Test";
        MapBasedMapperFromPropertiesFile instance = new MapBasedMapperFromPropertiesFile();
